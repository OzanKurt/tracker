...
use Kurt\Support\ServiceProvider as KurtServiceProvider;
...
use Kurt\Tracker\Services\Authentication;
use Kurt\Tracker\Support\Cache;
...
use Kurt\Tracker\Vendor\Laravel\Artisan\Tables as TablesCommand;
use Kurt\Tracker\Vendor\Laravel\Artisan\UpdateGeoIp;
        ...
        $this->app->singleton('tracker.repositories', function ($app) {
            ...
            $manager = new RepositoryManager(
                ...
                new Referer(
                    ...
                    $this->getAppUrl(),
                    $app->make('Kurt\Tracker\Support\RefererParser')
                ),
                $routeRepository,
