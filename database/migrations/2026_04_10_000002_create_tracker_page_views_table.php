...
return new class extends Migration
{
    ...
    {
        Schema::connection(config('tracker.connection'))->create('tracker_page_views', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection(config('tracker.connection'))->dropIfExists('tracker_page_views');
    }
};
